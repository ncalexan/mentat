...
// _our_ consumers likely don't care about the specific Mentat error type.
impl From<ProjectorError> for Error {
    fn from(error: ProjectorError) -> Error {
        Error::MentatError(MentatError::ProjectorError(error))
    }
}
